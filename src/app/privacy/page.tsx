  ...
  return (
    <div className="container mx-auto max-w-4xl py-12 px-4">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800">2. Information We Collect</h2>
          ...
          <ul className="list-disc pl-6 mb-4 text-gray-700">
            ...
            <li>Government-issued identification documents (as required for compliance services)</li>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800">3. How We Use Your Information</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            We use the information we collect for various purposes, including:
          </p>
          <ul className="list-disc pl-6 mb-4 text-gray-700">
            <li>Providing and maintaining our services</li>
            <li>Processing your registrations, licenses, and compliance filings</li>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800">4. Information Sharing and Disclosure</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            We may share your information in the following circumstances:
          </p>
          <ul className="list-disc pl-6 mb-4 text-gray-700">
            <li><strong>Government Authorities:</strong> When required for regulatory filings and compliance purposes</li>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800">7. Cookies and Tracking Technologies</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800">8. Children's Privacy</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-800">9. Changes to This Privacy Policy</h2>
          <p className="text-gray-700 leading-relaxed">
