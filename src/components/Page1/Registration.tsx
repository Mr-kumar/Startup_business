            ...
            <div className="bg-white rounded-xl shadow-xl p-6 border border-gray-100 relative overflow-hidden">
              ...
              {otpStep === 'success' && (
                <div className="text-center space-y-4">
                  ...
                  <h3 className="text-2xl font-bold text-[#1D293D]">Registration Confirmed!</h3>
                  <p className="text-gray-600">
                    Your registration has been completed successfully. Our expert will contact you soon!
                  </p>
