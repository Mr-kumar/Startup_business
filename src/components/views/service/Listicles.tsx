...
interface ListiclesProps {
  listicles?: ListicleItem[];
}

const Listicles: React.FC<ListiclesProps> = ({ listicles = [] }) => {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold text-[#1D293D] mb-6">Listicles</h2>
      {listicles.map((item, index) => (
