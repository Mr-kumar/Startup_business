    ...
    subItems: [
      ...
      },
      {
        ...
        links: [
          ...
          { name: "One Person Company Registration", href: "/startup/opc-registration" },
          { name: "Partnership Firm Registration", href: "/startup/partnership-firm-registration" },
          { name: "Sole Proprietorship Registration", href: "/startup/sole-proprietorship-registration" },
    ...
    subItems: [
      {
        ...
        links: [
          { name: "Trademark Registration", href: "/startup/trademark-registration" },
          { name: "Trademark Objection", href: "/trademark-objection-in-india" },
          { name: "Trademark Assignment", href: "/trademark-assignment-in-india" },
          { name: "Design Registration", href: "/startup/design-registration" },
          { name: "Trademark Rectification", href: "/startup/trademark-rectification" },
          { name: "Intellectual Property Dispute", href: "/intellectual-property-dispute" },
          { name: "International Trademark Registration", href: "/startup/international-trademark-registration" },
          ...
          { name: "Registration OF Geographical Indication (GI)", href: "/startup/gi-registration" },
    ...
    subItems: [
      {
        title: "Tax Filing",
        links: [
          { name: "GST Registration", href: "/startup/gst-registration" },
          { name: "GST Return Filing", href: "/startup/gst-return-filing" },
